...
def train_model():
    ...
    history = model.fit(
        ...
        steps_per_epoch=TRAIN_STEPS,  # Use calculated steps_per_epoch
        validation_steps=VAL_STEPS,  # Use calculated validation_steps
        callbacks=callbacks
    )
...
if __name__ == "__main__":
    ...
    # Save the model (both locally and to Google Drive)
    model.save('food41_classifier_model.h5')  # Local save
    model.save(os.path.join(SAVE_DIR, 'food41_classifier_model.h5')) # Google Drive save


    sample_image_path = os.path.join(DATASET_PATH, os.listdir(DATASET_PATH)[0],
